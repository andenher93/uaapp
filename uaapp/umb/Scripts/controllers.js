angular.module('app.controllers', ['app.services']).
    controller('AppController', ['$rootScope', '$scope', '$location', 'contentService', '$sce', function ($rootScope, $scope, $location, contentService, $sce) {
    ...
    .controller('RouteController', ['$scope', 'PublishedContent', 'contentService', function ($scope, PublishedContent, contentService) {
        ...
        $scope.$on('$stateChangeSuccess', function (event) {
            document.title = $scope.content.title ? $scope.content.title : $scope.content.Name;
        });
